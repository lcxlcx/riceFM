...
class TransformerModel(nn.Module):
    def __init__(
        ...
        encoder_layers = RicefmTransformerEncoderLayer(
            d_model,
            nhead,
            d_hid,
            dropout,
    ...
    def _encode(
        ...
        mod_types: Optional[Tensor] = None,  # (batch,)
        ...
        if self.input_emb_style == "scaling":
            ...
            # total_embs = src + values
            total_embs = src + values + mod_type_embs.unsqueeze(1).repeat(1, src.shape[1], 1)
    ...
    def forward(
        ...
        transformer_output = self._encode(
            src, values, src_key_padding_mask, mod_types, batch_labels
        )
...
class RicefmTransformerEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if src_mask is not None:
            raise ValueError("RicefmTransformerEncoderLayer does not support src_mask")
